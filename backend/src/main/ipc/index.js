...
import { ok, toErrorEnvelope } from './envelope.js'
import { appHandlers } from './app.ipc.js'
import { backupHandlers } from './backup.ipc.js'
import { familyHandlers } from './family.ipc.js'
import { familyMemberHandlers } from './family-member.ipc.js'
import { personHandlers } from './person.ipc.js'
import { zoneHandlers } from './zone.ipc.js'
import { settingHandlers } from './setting.ipc.js'
 ...
 */
function register({ channel, schema, handle, withMeta, event }) {
