 ...
 * @returns {T}
 */
export function assertFound(record, message) {
 ...
 */
export function assertVersion(current, expectedUpdatedAt) {
 ...
 */
export function pageMeta(total, filter = {}) {
 ...
 * @returns {string}
 */
export function requireText(value, field, message) {
  if (value === null) {
