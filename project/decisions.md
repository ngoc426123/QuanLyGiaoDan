...
| --- | ---------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------- | ---------- |
| P01 | 2026-09-22 | Bí tích lưu tại bảng `sacraments`, một bản ghi mỗi người cho Rửa tội, Rước lễ lần đầu, Thêm sức và Hôn phối; có ngày và linh mục cử hành                                                            | Hồ sơ cần lưu thông tin bí tích ngoài ngày. Cột ngày cũ được migration sang bảng mới và không còn là nguồn dữ liệu chính                                                                                                                                                                                                                                                        | Trung bình — thêm trường sổ bộ/chứng thư bằng migration mới                                       | Hiệu lực   |
...
| P14 | 2026-09-13 | Bản **dev** ghi vào `userData` riêng: `<appData>/quan-ly-giao-dan-dev`; bản phát hành dùng `<appData>/Quan Ly Giao Dan`                                                                             | Không tách thì mọi lần chạy thử và mọi migration dở dang đổ thẳng vào dữ liệu thật của người dùng. Bản phát hành tự chuyển thư mục `elecrusion` cũ sang tên mới một lần để dữ liệu và khóa DPAPI vẫn dùng được.                                                                                                                                                                 | Dễ                                                                                                | Hiệu lực   |
...
| P22 | 2026-09-25 | Bảng `persons` dùng chung cho giáo dân trong xứ và người ngoài xứ qua `person_type` (`parish` hoặc `external`); bí tích, hôn phối và quan hệ cha/mẹ đều tham chiếu một `person_id`                  | Hai tính năng hôn phối và cha/mẹ cần tái sử dụng cùng một hồ sơ người. Một khoá ngoại duy nhất giữ schema, chứng thư và bí tích nhất quán; Service chặn người ngoài xứ tham gia hộ, giáo họ và báo cáo giáo dân                                                                                                                                                                 | Trung bình — migration chuyển dữ liệu develop và thay đổi mọi truy vấn người                      | Hiệu lực   |
