...
export const VirtualList = forwardRef<any, any>(function VirtualList(
  ...
  function handleKey(event) {
    ...
    setGeometry((state) => ({ ...state, top: viewport.current?.scrollTop ?? 0 }))
  }
  ...
  return (
    ...
    >
      <div
        ...
        style={{ '--virtual-height': `${items.length * geometry.row}px` } as any}
      >
        {visible.map((item, offset) => (
          <div
            ...
            style={{ '--virtual-offset': `${(start + offset) * geometry.row}px` } as any}
          >
